...
\begin{document}
  ...
  \section{Status of results}
    ...
    \paragraph{Linear-growth depths do not supply the generation stabilisation scale.}
      ...
      \(\sigma_{\mathrm{pair}}(n),\sigma_c(n)\) of the relaxation cascade, is intrinsic and stable in the
    ...
    \paragraph{Quantised resolution-density frontier.}
      ...
      the crossing regime rather than in the observed stabilisation window.
      ...
      The resolution-density route therefore converts the previous obstruction into a sharper open question:
      whether the valency \(|S|\) is intrinsically part of the density quantum, or whether the raw Cayley
      transport is not the correct Weil--Schur profile.
  ...
  \section{Reproducibility}
    ...
    intrinsic but \(\le 10\) and non-splitting cumulative-capacity cell depth on the relaxation profiles, and
    the \(q\)-instability of both the inter-level gap and the \(n_2,n_3\) order ---
