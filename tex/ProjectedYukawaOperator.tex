...
\hypersetup{
  ...
  pdftitle={Projected Yukawa Operator and Chiral Polar Factor:
            The Squared Observable H_Π = Y_Π†Y_Π and the Undetermined Chiral Polar Map U_Π},
...
\begin{document}
  ...
  \section{Polar class of the projected Yukawa operator}
    ...
    \begin{corollary}[Real-cascade collapse]
      ...
      defect being the real $V\!-\!A$ diagonal split~\cite{Beau2026prs} and the first-order generation-mixing
      coefficient of $E_\Pi^2$ vanishing by antiunitary parity in every covariant family~\cite{Beau2026ebj}; hence $A$
      is diagonal,
