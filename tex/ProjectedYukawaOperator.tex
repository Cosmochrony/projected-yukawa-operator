...
\begin{document}
  ...
  \section{Status of results}
    ...
    \paragraph{Separation of level split and hierarchy.}
      ...
      The observed hierarchy must be carried by an additional amplification mechanism, such as the spectral cascade
      exponent, the sector-dependent normalisation of \(\lamY\), or a downstream operator acting after the
      squared-level split.
