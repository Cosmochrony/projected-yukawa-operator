...
\begin{document}
  ...
  \section{Status of results}
    ...
    \paragraph{Open.}
      ...
      The norm $\lamY$ scales $\Hpi$, whereas a non-trivial $[\Upi]$ requires a genuine complex metaplectic
      phase, conditional on an unprescribed phase and ordering~\cite{Beau2026bim}, and observable as a mixing
      matrix only relative to a second fermionic sector.
